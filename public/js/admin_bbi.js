...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  async function displayEvacuationCenters(searchTerm = "") {
    try {
      ...
      centers.forEach((center) => {
        ...
        const matchesStatusFilter =
          statusFilter === "" || center.status === statusFilter;
  ...
  document
    .getElementById("bdrrmc-incident-status-filter")
    .addEventListener("change", (e) => {
      debouncedIncidentSearch(
        document.getElementById("bdrrmc-incidents-search").value
      );
    });

  document
    .getElementById("bdrrmc-evac-status-filter")
    .addEventListener("change", (e) => {
      debouncedEvacuationSearch(
        document.getElementById("bdrrmc-evacuation-search").value
      );
    });

  document
    .getElementById("bdrrmc-relief-status-filter")
    .addEventListener("change", (e) => {
      debouncedReliefSearch(
        document.getElementById("bdrrmc-relief-search").value
      );
    });
